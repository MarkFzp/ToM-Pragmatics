...
train_config.pretrain_steps = 10
train_config.continue_steps = 1
train_config.pretrain_batch_size = 128
train_config.feature_lr = 0
train_config.belief_lr = 1e-2
train_config.feature_decay = None
train_config.belief_decay = None
train_config.regularization_param = 0
train_config.save_period = 10000
train_config.print_period = 1
...
if game_config.dataset == 'Geometry':
    ...
    game_config.attributes = range(game_config.message_space_size)
...
if vision_config.type == 'CNN':
    ...
    '''
    game_config.feat_dir = '/home/Datasets/%s/' % game_config.dataset
elif vision_config.type == 'VGG16':
    vision_config.img_h = 224
    vision_config.img_w = 224
    vision_config.fc_configs = [1024, 256]
